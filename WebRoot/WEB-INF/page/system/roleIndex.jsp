...
<HTML>
	<HEAD>
		...
		function saveRole(){
		   ...
		   $("#Form2").attr("action","${pageContext.request.contextPath }/system/elecRoleAction_saveRole.do");
		   $("#Form2").submit();
		}
				...
				<TBODY>
					...
					<tr>
						...
						<td class="ta_01" align="left"  width="65%" >
							...
							<s:select list="#request.elecRoleList"
							name="roleID" id="Form1_roleID" class="bg" style="width:180px" onchange="selectRole()"
