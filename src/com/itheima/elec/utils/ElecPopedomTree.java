...
public class ElecPopedomTree implements java.io.Serializable {
	...
	/**非持久化javabean属性*/
	//表示如果一个父包含的所有子的集合
	private List<ElecPopedom> nodes = new ArrayList<ElecPopedom>();
	//角色ID
   ...
   flag=2：没有被选中
	...
	public List<ElecPopedom> getNodes() {
		return nodes;
	}
	public void setNodes(List<ElecPopedom> nodes) {
		this.nodes = nodes;
	}
